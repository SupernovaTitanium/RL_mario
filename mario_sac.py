...
def train(opt,writer):
    ...
    for iter in range(opt.num_global_steps):
        ...
        # for i in range(20):
        #     print(torch.sum(memory_s[i]))
        #     print(memory_s_info[i])
        #     print(memory_a[i])
        #     print(memory_r[i])
        #     print(memory_d[i])
        # updating
...
def get_args():
    ...
    parser.add_argument("--memory_size", type=int, default="75000")
